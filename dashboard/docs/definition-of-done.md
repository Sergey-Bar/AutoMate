...
- [ ] Any behavior changes are reflected in docs (README, docs-site, or API docs).
...
- [ ] `pnpm --filter @automate/dashboard-server test` passes.
- [ ] `pnpm --filter @automate/dashboard-client test` passes.
- [ ] `pnpm build` passes.
