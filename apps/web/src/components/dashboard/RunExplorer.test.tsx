...
const result = {
  ...
  attempts: [{ index: 1, testId: 'test-1', specPath: 'tests/example.spec.ts', title: 'Example', status: 'passed', rawStatus: 'passed', startedAt: '2026-09-25T00:00:00.000Z', evidence: [], flakiness: 'unknown' }],
  evidence: [],
  provenance: { producer: 'playwright', producerVersion: '1', adapterVersion: '1', sourceDigest: 'a'.repeat(64), sourceUri: 'artifact://run/report.json' },
