  ...
  return (
    ...
    >
      ...
      >
        ...
        {error !== null && (
          <p role="alert" data-testid="error-msg" style={{ color: '#c00', fontSize: 14 }}>
            Error: {error}
          </p>
        )}
      </div>
      ...
      >
        ...
        {result === null && !isLoading && (
          <p data-testid="empty-state" style={{ color: '#999', fontSize: 14 }}>
            Generated Playwright test code will appear here.
          </p>
        )}

        {isLoading && (
          <p data-testid="loading-state" style={{ color: '#666', fontSize: 14 }}>Generating test…</p>
        )}
        ...
        {result !== null && (
          <>
            ...
            {result.explanation && (
              <div data-testid="explanation" style={{ fontSize: 14, color: '#444', marginTop: 8 }}>
