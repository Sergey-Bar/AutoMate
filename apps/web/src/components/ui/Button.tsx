...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-lg transition-all duration-150 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-border-focus active:scale-[0.98]',
  {
    variants: {
      variant: {
        destructive: 'font-medium text-white bg-error hover:brightness-110', // Alias for danger variant
        ...
        danger: 'font-medium text-white bg-error hover:brightness-110',
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', loading, icon, iconRight, children, className = '', disabled, style, ...rest }, ref) => {
